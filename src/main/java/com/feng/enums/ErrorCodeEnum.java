...
public enum ErrorCodeEnum {
    ...
    USERNAME_HAS_REGISTER("0104", "用户名已经注册"),
    USERIDCARD_HAS_REGISTER("0105", "身份证号码已经注册"),
    ...
    IMAGE_CODE_ERROR2("02007", "验证码错误"),
    NOT_ALIVE_USER("0201", "用户未登录"),
    PASSWORD_ERROR("0202", "密码错误"),
    NOT_HAVE_PHONE("0203", "没有该手机号"),
    REGISTER_ERROR("0205", "注册失败"),
    PARAMS_IS_NULL_ERROR("0206", "参数为空"),
    ...
    ORDER_SAVE_ERROR("0304","订单保存错误"),

    /**
     * 04XX 未知错误
     */
    UNKOWN_ERROR("0400", "未知错误"),
    NOT_HAVE_ERROR("0401", "没有权限"),
    ...
    FILE_UPLOAD_ERROR("0604", "文件类型错误"),
    FILE_SiZE_ERROR("0605", "文件大小错误"),
